...
export const MATERIALS = {
  ...
  gold:    { name: 'GOLD',    color: '#ffc850', density: 15.0, restitution: 0.35, friction: 0.32, metallic: 1.0,  glow: 0.2,  refract: 0,    pitch: 440,  timbre: 'triangle', deform: 0.60, roll: 0.095, heatKeep: 0.9988, cond: 0.95, bounceBack: 0.10, dentable: true },
